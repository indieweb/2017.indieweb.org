...
$year = 2017;
$city = 'Austin, Texas';
$url = 'https://2017.indieweb.org/austin';
$summary = 'IndieWebCamp Austin 2017 is a gathering for independent web creators of all kinds, from graphic artists, to designers, UX engineers, coders, hackers, to share ideas, actively work on creating for their own personal websites, and build upon each others creations.';
...
<div class="pusher">
  ...
  <div class="ui vertical stripe segment" id="register">
    <div class="ui text container">
      ...
      Please <a href="https://www.eventbrite.com/e/indiewebcamp-austin-2017-tickets-39918084064">register on EventBrite</a>
    </div>
  </div>
...
var marker = L.marker([30.268821, -97.740726]).addTo(map);
marker.bindPopup("<b>Capital Factory</b><br>701 Brazos St<br>Austin, Texas").openPopup();
