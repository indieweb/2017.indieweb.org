<?php
$event = 'nyc';
$title = 'IndieWebCamp New York';
$date = 'Sep 30 - Oct 1, 2017';
$year = 2017;
$city = 'New York City';
$url = 'https://2017.indieweb.org/nyc';
$summary = 'IndieWebCamp NYC 2017 is a gathering for independent web creators of all kinds, from graphic artists, to designers, UX engineers, coders, hackers, to share ideas, actively work on creating for their own personal websites, and build upon each others creations.';
...
<div class="pusher">
  ...
  <div class="ui vertical stripe segment" id="register">
    <div class="ui text container">
      ...
      <tito-widget event="indiewebcamp/nyc-2017"><a href="https://ti.to/indiewebcamp/nyc-2017">Get Tickets</a></tito-widget>
...
var marker = L.marker([40.744680, -73.984902]).addTo(map);
marker.bindPopup("<b>Dalberg Global Development Advisors NYC</b><br>99 Madison Avenue, Floor 17<br>New York, NY").openPopup();
